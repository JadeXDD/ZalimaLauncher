...
val nameId = "com.movtery.zalimalauncher"
val generatedZalimaDir = file("$buildDir/generated/source/zalima/java")
...
android {
    ...
    sourceSets["main"].java.srcDirs(generatedZalimaDir)
...
tasks.register("generateInfoDistributor") {
    doLast {
        ...
        generateJavaClass(generatedZalimaDir, "com.movtery.zalimalauncher", "InfoDistributor", constantMap)
    }
}
