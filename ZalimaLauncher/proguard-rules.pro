...
-keep class com.movtery.zalimalauncher.bridge.** { *; }
-keep class com.movtery.zalimalauncher.utils.device.VulkanChecker {
    *;
}
-keep class com.movtery.zalimalauncher.utils.device.VulkanCapabilities {
    *;
}
-keep interface com.movtery.zalimalauncher.utils.device.VulkanLogCallback {
    *;
}
-keep class com.movtery.zalimalauncher.game.input.CriticalNativeTest {
    *;
}
