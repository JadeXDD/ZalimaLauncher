package com.movtery.zalimalauncher.feature.update
...
import com.movtery.zalimalauncher.feature.update.LauncherVersion.FileSize
...
import com.movtery.zalimalauncher.ui.dialog.UpdateDialog
import com.movtery.zalimalauncher.utils.path.PathManager
import com.movtery.zalimalauncher.utils.ZHTools
import com.movtery.zalimalauncher.utils.http.CallUtils
import com.movtery.zalimalauncher.utils.http.CallUtils.CallbackListener
...
class UpdateUtils {
    companion object {
        ...
        fun getDownloadUrl(launcherVersion: LauncherVersion): String {
            ...
            return "https://github.com/ZalimaLauncher/ZalimaLauncher/releases/download/" +
                    "${launcherVersion.versionCode}/ZalimaLauncher-${launcherVersion.versionName}" +
