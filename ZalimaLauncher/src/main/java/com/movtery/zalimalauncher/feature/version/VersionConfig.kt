...
import com.movtery.zalimalauncher.feature.version.VersionsManager.getZalimaVersionPath
import com.movtery.zalimalauncher.setting.AllSettings
import com.movtery.zalimalauncher.utils.stringutils.StringUtils.getStringNotNull
...
class VersionConfig(private var versionPath: File) : Parcelable {
    ...
    fun saveWithThrowable() {
        ...
        val configFile = File(zalimaVersionPath, "VersionConfig.json")
    ...
    companion object CREATOR : Parcelable.Creator<VersionConfig> {
        ...
        fun parseConfig(versionPath: File): VersionConfig {
            ...
            val oldConfigFile = File(getZalimaVersionPath(versionPath), "ZalimaVersion.cfg")
            val configFile = File(getZalimaVersionPath(versionPath), "VersionConfig.json")
