package com.movtery.zalimalauncher.ui.fragment.download.resource
...
import com.movtery.zalimalauncher.databinding.FragmentDownloadResourceBinding
import com.movtery.zalimalauncher.event.value.DownloadPageEvent
import com.movtery.zalimalauncher.event.value.DownloadPageEvent.PageSwapEvent.Companion.IN
import com.movtery.zalimalauncher.event.value.DownloadPageEvent.PageSwapEvent.Companion.OUT
import com.movtery.zalimalauncher.feature.download.Filters
import com.movtery.zalimalauncher.feature.download.InfoAdapter
import com.movtery.zalimalauncher.feature.download.SelfReferencingFuture
import com.movtery.zalimalauncher.feature.download.enums.Category
import com.movtery.zalimalauncher.feature.download.enums.Classify
import com.movtery.zalimalauncher.feature.download.enums.ModLoader
import com.movtery.zalimalauncher.feature.download.enums.Platform
import com.movtery.zalimalauncher.feature.download.enums.Sort
import com.movtery.zalimalauncher.feature.download.item.InfoItem
import com.movtery.zalimalauncher.feature.download.item.SearchResult
import com.movtery.zalimalauncher.feature.download.platform.PlatformNotSupportedException
import com.movtery.zalimalauncher.feature.log.Logging
import com.movtery.zalimalauncher.task.TaskExecutors
import com.movtery.zalimalauncher.ui.dialog.SelectVersionDialog
import com.movtery.zalimalauncher.ui.fragment.FragmentWithAnim
import com.movtery.zalimalauncher.ui.subassembly.adapter.ObjectSpinnerAdapter
import com.movtery.zalimalauncher.ui.subassembly.versionlist.VersionSelectedListener
import com.movtery.zalimalauncher.utils.ZHTools
import com.movtery.zalimalauncher.utils.anim.AnimUtils.Companion.setVisibilityAnim
