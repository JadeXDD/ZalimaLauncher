...
package com.movtery.zalimalauncher.ui.screens.content.versions
...
import com.movtery.zalimalauncher.coroutine.TaskSystem
import com.movtery.zalimalauncher.game.addons.modloader.ModLoader
import com.movtery.zalimalauncher.game.download.assets.platform.Platform
import com.movtery.zalimalauncher.game.download.assets.utils.getMcmodTitle
import com.movtery.zalimalauncher.game.version.installed.Version
import com.movtery.zalimalauncher.game.version.installed.VersionFolders
import com.movtery.zalimalauncher.game.version.mod.AllModReader
import com.movtery.zalimalauncher.game.version.mod.LocalMod
import com.movtery.zalimalauncher.game.version.mod.RemoteMod
import com.movtery.zalimalauncher.game.version.mod.isDisabled
import com.movtery.zalimalauncher.game.version.mod.isEnabled
import com.movtery.zalimalauncher.game.version.mod.update.ModManifest
import com.movtery.zalimalauncher.game.version.mod.update.ModUpdater
import com.movtery.zalimalauncher.game.version.mod.update.SelectableModManifest
import com.movtery.zalimalauncher.game.version.mod.update.toSelectableList
import com.movtery.zalimalauncher.ui.base.BaseScreen
import com.movtery.zalimalauncher.ui.components.CardTitleLayout
import com.movtery.zalimalauncher.ui.components.EdgeDirection
import com.movtery.zalimalauncher.ui.components.IconTextButton
import com.movtery.zalimalauncher.ui.components.LittleTextLabel
import com.movtery.zalimalauncher.ui.components.ScalingLabel
import com.movtery.zalimalauncher.ui.components.SimpleTextInputField
import com.movtery.zalimalauncher.ui.components.TooltipIconButton
import com.movtery.zalimalauncher.ui.components.fadeEdge
import com.movtery.zalimalauncher.ui.screens.NestedNavKey
import com.movtery.zalimalauncher.ui.screens.NormalNavKey
import com.movtery.zalimalauncher.ui.screens.TitledNavKey
import com.movtery.zalimalauncher.ui.screens.content.download.assets.elements.AssetsIcon
import com.movtery.zalimalauncher.ui.screens.content.elements.ImportMultipleFileButton
import com.movtery.zalimalauncher.ui.screens.content.elements.ModLoaderIcon
import com.movtery.zalimalauncher.ui.screens.content.elements.SortByDropdownMenu
import com.movtery.zalimalauncher.ui.screens.content.elements.SortByEnum
import com.movtery.zalimalauncher.ui.screens.content.elements.rememberMultipleUriImportTaskBuilder
import com.movtery.zalimalauncher.ui.screens.content.versions.elements.ByteArrayIcon
import com.movtery.zalimalauncher.ui.screens.content.versions.elements.DeleteAllOperation
import com.movtery.zalimalauncher.ui.screens.content.versions.elements.LoadingState
import com.movtery.zalimalauncher.ui.screens.content.versions.elements.ModStateFilter
import com.movtery.zalimalauncher.ui.screens.content.versions.elements.ModsConfirmOperation
import com.movtery.zalimalauncher.ui.screens.content.versions.elements.ModsOperation
import com.movtery.zalimalauncher.ui.screens.content.versions.elements.ModsUpdateOperation
import com.movtery.zalimalauncher.ui.screens.content.versions.elements.filterMods
import com.movtery.zalimalauncher.ui.screens.content.versions.layouts.VersionChunkBackground
import com.movtery.zalimalauncher.ui.theme.itemColor
import com.movtery.zalimalauncher.ui.theme.onItemColor
import com.movtery.zalimalauncher.utils.animation.getAnimateTween
import com.movtery.zalimalauncher.utils.animation.swapAnimateDpAsState
import com.movtery.zalimalauncher.utils.file.FolderFileCounter
import com.movtery.zalimalauncher.utils.file.formatFileSize
import com.movtery.zalimalauncher.utils.string.isNotEmptyOrBlank
import com.movtery.zalimalauncher.viewmodel.ErrorViewModel
import com.movtery.zalimalauncher.viewmodel.EventViewModel
import com.movtery.zalimalauncher.viewmodel.sendKeepScreen
