...
import com.movtery.zalimalauncher.path.GLOBAL_JSON
import com.movtery.zalimalauncher.path.URL_PROJECT_INFO
...
import com.movtery.zalimalauncher.ui.upgrade.UpgradeDialog
import com.movtery.zalimalauncher.ui.upgrade.UpgradeFilesDialog
import com.movtery.zalimalauncher.upgrade.GithubContentApi
import com.movtery.zalimalauncher.upgrade.RemoteData
...
import com.movtery.zalimalauncher.utils.string.decodeBase64
...
private const val LATEST_API_CHINESE_URL = "https://repo.miawa.cn/zalima-info/v2/$LATEST_VERSION"
