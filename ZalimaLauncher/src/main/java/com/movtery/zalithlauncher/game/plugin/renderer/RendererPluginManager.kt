...
package com.movtery.zalimalauncher.game.plugin.renderer

import android.content.Context
import android.content.pm.ApplicationInfo
import com.movtery.zalimalauncher.R
import com.movtery.zalimalauncher.game.plugin.ApkPlugin
import com.movtery.zalimalauncher.game.plugin.ApkPluginManager
import com.movtery.zalimalauncher.game.plugin.cacheAppIcon
import com.movtery.zalimalauncher.game.renderer.Renderers

/**
 * FCL、ZalimaLauncher 渲染器插件，同时支持使用本地渲染器插件
    ...
    override fun parseApkPlugin(
        ...
        if (info.flags and ApplicationInfo.FLAG_SYSTEM == 0) {
            ...
            if (
                ...
                metaData.getBoolean("zalimaRendererPlugin", false)
            ) {
