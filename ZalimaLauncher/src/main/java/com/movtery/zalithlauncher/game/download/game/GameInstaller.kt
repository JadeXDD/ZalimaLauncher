...
package com.movtery.zalimalauncher.game.download.game

import android.content.Context
import android.content.Intent
import com.movtery.zalimalauncher.R
import com.movtery.zalimalauncher.context.GlobalContext
import com.movtery.zalimalauncher.coroutine.Task
import com.movtery.zalimalauncher.coroutine.TaskFlowExecutor
import com.movtery.zalimalauncher.coroutine.TitledTask
import com.movtery.zalimalauncher.coroutine.addTask
import com.movtery.zalimalauncher.coroutine.buildPhase
import com.movtery.zalimalauncher.game.addons.mirror.mapBMCLMirrorUrls
import com.movtery.zalimalauncher.game.addons.modloader.ModLoader
import com.movtery.zalimalauncher.game.addons.modloader.cleanroom.CleanroomVersion
import com.movtery.zalimalauncher.game.addons.modloader.fabriclike.FabricLikeVersion
import com.movtery.zalimalauncher.game.addons.modloader.forgelike.ForgeLikeVersion
import com.movtery.zalimalauncher.game.addons.modloader.forgelike.neoforge.NeoForgeVersion
import com.movtery.zalimalauncher.game.addons.modloader.modlike.ModVersion
import com.movtery.zalimalauncher.game.download.assets.platform.mcim.mapMCIMMirrorUrls
import com.movtery.zalimalauncher.game.download.game.cleanroom.getCleanroomDownloadTask
import com.movtery.zalimalauncher.game.download.game.cleanroom.targetTempCleanroomInstaller
import com.movtery.zalimalauncher.game.download.game.fabric.getFabricLikeCompleterTask
import com.movtery.zalimalauncher.game.download.game.fabric.getFabricLikeDownloadTask
import com.movtery.zalimalauncher.game.download.game.forge.getForgeLikeAnalyseTask
import com.movtery.zalimalauncher.game.download.game.forge.getForgeLikeDownloadTask
import com.movtery.zalimalauncher.game.download.game.forge.getForgeLikeInstallTask
import com.movtery.zalimalauncher.game.download.game.forge.isNeoForge
import com.movtery.zalimalauncher.game.download.game.forge.targetTempForgeLikeInstaller
import com.movtery.zalimalauncher.game.download.game.optifine.getOptiFineDownloadTask
import com.movtery.zalimalauncher.game.download.game.optifine.getOptiFineInstallTask
import com.movtery.zalimalauncher.game.download.game.optifine.getOptiFineModsDownloadTask
import com.movtery.zalimalauncher.game.download.game.optifine.targetTempOptiFineInstaller
import com.movtery.zalimalauncher.game.download.jvm_server.JVMSocketServer
import com.movtery.zalimalauncher.game.download.jvm_server.JvmService
import com.movtery.zalimalauncher.game.path.getGameHome
import com.movtery.zalimalauncher.game.version.download.BaseMinecraftDownloader
import com.movtery.zalimalauncher.game.version.download.MinecraftDownloader
import com.movtery.zalimalauncher.game.version.installed.VersionConfig
...
import com.movtery.zalimalauncher.utils.file.copyDirectoryContents
import com.movtery.zalimalauncher.utils.logging.Logger
import com.movtery.zalimalauncher.utils.network.downloadFromMirrorListSuspend
import com.movtery.zalimalauncher.utils.network.withSpeedReport
