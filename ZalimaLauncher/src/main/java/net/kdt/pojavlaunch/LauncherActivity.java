...
import static com.movtery.zalimalauncher.launch.LaunchGame.preLaunch;
...
import com.movtery.zalimalauncher.InfoDistributor;
import com.movtery.zalimalauncher.R;
import com.movtery.zalimalauncher.context.ContextExecutor;
import com.movtery.zalimalauncher.databinding.ActivityLauncherBinding;
import com.movtery.zalimalauncher.event.single.LaunchGameEvent;
import com.movtery.zalimalauncher.event.single.MainBackgroundChangeEvent;
import com.movtery.zalimalauncher.event.single.PageOpacityChangeEvent;
import com.movtery.zalimalauncher.event.single.SwapToLoginEvent;
import com.movtery.zalimalauncher.event.sticky.MinecraftVersionValueEvent;
import com.movtery.zalimalauncher.event.value.AddFragmentEvent;
import com.movtery.zalimalauncher.event.value.DownloadProgressKeyEvent;
import com.movtery.zalimalauncher.event.value.InstallGameEvent;
import com.movtery.zalimalauncher.event.value.InstallLocalModpackEvent;
import com.movtery.zalimalauncher.event.value.LocalLoginEvent;
import com.movtery.zalimalauncher.event.value.MicrosoftLoginEvent;
import com.movtery.zalimalauncher.event.value.OtherLoginEvent;
import com.movtery.zalimalauncher.feature.accounts.AccountType;
import com.movtery.zalimalauncher.feature.accounts.AccountsManager;
import com.movtery.zalimalauncher.feature.accounts.LocalAccountUtils;
import com.movtery.zalimalauncher.feature.background.BackgroundManager;
import com.movtery.zalimalauncher.feature.background.BackgroundType;
import com.movtery.zalimalauncher.feature.download.item.ModLoaderWrapper;
import com.movtery.zalimalauncher.feature.log.Logging;
import com.movtery.zalimalauncher.feature.mod.modpack.install.InstallExtra;
import com.movtery.zalimalauncher.feature.mod.modpack.install.InstallLocalModPack;
import com.movtery.zalimalauncher.feature.mod.modpack.install.ModPackInfo;
import com.movtery.zalimalauncher.feature.mod.modpack.install.ModPackUtils;
import com.movtery.zalimalauncher.feature.notice.CheckNewNotice;
import com.movtery.zalimalauncher.feature.notice.NoticeInfo;
import com.movtery.zalimalauncher.feature.update.UpdateUtils;
import com.movtery.zalimalauncher.feature.version.Version;
import com.movtery.zalimalauncher.feature.version.VersionsManager;
import com.movtery.zalimalauncher.feature.version.install.GameInstaller;
import com.movtery.zalimalauncher.feature.version.install.InstallTask;
import com.movtery.zalimalauncher.plugins.renderer.RendererPlugin;
import com.movtery.zalimalauncher.plugins.renderer.RendererPluginManager;
...
import com.movtery.zalimalauncher.ui.activity.BaseActivity;
import com.movtery.zalimalauncher.ui.activity.ErrorActivity;
import com.movtery.zalimalauncher.ui.dialog.EditTextDialog;
import com.movtery.zalimalauncher.ui.dialog.TipDialog;
import com.movtery.zalimalauncher.ui.fragment.AccountFragment;
import com.movtery.zalimalauncher.ui.fragment.BaseFragment;
import com.movtery.zalimalauncher.ui.fragment.DownloadFragment;
import com.movtery.zalimalauncher.ui.fragment.DownloadModFragment;
import com.movtery.zalimalauncher.ui.fragment.SettingsFragment;
import com.movtery.zalimalauncher.ui.subassembly.settingsbutton.ButtonType;
import com.movtery.zalimalauncher.ui.subassembly.settingsbutton.SettingsButtonWrapper;
import com.movtery.zalimalauncher.ui.subassembly.view.DraggableViewWrapper;
import com.movtery.zalimalauncher.utils.StoragePermissionsUtils;
import com.movtery.zalimalauncher.utils.ZHTools;
import com.movtery.zalimalauncher.utils.anim.ViewAnimUtils;
import com.movtery.zalimalauncher.utils.file.FileTools;
import com.movtery.zalimalauncher.utils.image.ImageUtils;
import com.movtery.zalimalauncher.utils.stringutils.ShiftDirection;
import com.movtery.zalimalauncher.utils.stringutils.StringUtils;
