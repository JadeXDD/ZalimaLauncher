...
Java_com_movtery_zalimalauncher_utils_device_VulkanChecker_nativeSetLogCallback(
        JNIEnv *env,
        jclass clazz,
        jobject callback
) {
...
Java_com_movtery_zalimalauncher_utils_device_VulkanChecker_nativeCheckVulkan(
        JNIEnv *env,
        jclass clazz,
        jstring jDriverPath,
        jstring jNativeDir,
    ...
    VkApplicationInfo appInfo = {
            ...
            .pApplicationName = "ZalimaLauncher",
...
#undef PUT_FEAT
    ...
    jclass capClass = (*env)->FindClass(env, "com/movtery/zalimalauncher/utils/device/VulkanCapabilities");
